...
import org.suai.vdovin.lab10.stacks.SynchroStackFast;

public class ReadWriteStackFast {
    private final SynchroStackFast stack;
    private final int valueThreads;

    public ReadWriteStackFast(int valueThreads) {
        this.stack = new SynchroStackFast();
